...
styles/css: $(STYLUS_FILES)
	stylus --include-css styles/authentication.styl -o styles

styles/min.css: styles/css
	cssmin styles/*.css > styles/authentication.min.css

js/bdsft-webrtc-styles.js: styles/min.css
	mkdir -p js/ && node_modules/webrtc-core/scripts/export-style styles/authentication.min.css js/bdsft-webrtc-styles.js
